...
function checkDiff(datestr) {
    ...
    if (Date.now() - refreshed > diff) {
        text.innerHTML = `<div role="alert" class="border-s-4 border-red-700 bg-red-50 p-4 m-4">
                            <div class="flex items-center gap-2 text-red-700">
                                ...
                                <strong class="text-lg"> Dati non aggiornati </strong>
                                </div>
                                <a href="https://meteocentrocadore.cronitorstatus.com" class="underline mt-2">Controlla lo stato dei servizi</p>
                        </div>`;
    }
